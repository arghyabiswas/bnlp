	...
	public class EnglishNameFinder 
	{
		...
		private void CreateModels(string[] models)
		{
			for (int currentModel = 0; currentModel < models.Length; currentModel++)
			{
				...
				{
					string modelName = mModelPath + models[currentModel] + ".bnlp";
					SharpEntropy.IMaximumEntropyModel model = new SharpEntropy.GisModel(new SharpEntropy.IO.ModelReader(modelName));
