...
namespace SharpEntropy.IO
{
	...
	/// </version>
	public abstract class GisModelReader : IModelReader
	{
		...
		protected virtual void ReadModel()
		{
            ...
            int ParameterCount = ReadParameterCount();
        ...
        protected int ReadParameterCount()
        {
            return ReadInt32();
        }
		/// <summary>
		...
		protected virtual string[] ReadPredicateLabels()
		{
            ...
            {
                string[] _temp = s.Split('\t');
                _tempLabels.Add(_temp[0]);
            }
			
            return _tempLabels.ToArray();
		}
        ...
        protected abstract string[] ReadLines();
