            ...
            <tr>
                <td valign="top">
                    <div>
                        ...
                        <asp:Button ID="Button2" runat="server" Text="Analysis" OnClick="Button2_Click" />
                        <asp:Button ID="Button4" runat="server" Text="Google" OnClick="Button4_Click" />
                        <asp:Button ID="Button5" runat="server" Text="Translate Log" OnClick="Button5_Click" />
                        <asp:Button ID="Button6" runat="server" Text="Parse" OnClick="Button6_Click" />
                        <br />
